class AppController < ActionController::Base
  ...
  def settings
    ...
    if params[:code]
      ...
      @post = "https://vrapi.verticalresponse.com/api/v1/oauth/access_token?client_id=abcdh2wvxxdrw5zanb6wryhc&client_secret=abbcRjmGDCYqRGuyWAs5yJ4C&redirect_uri=https://vr-wix-widget.herokuapp.com/settings?compId=" + @comp_id + "&code=#{@auth_code}"
